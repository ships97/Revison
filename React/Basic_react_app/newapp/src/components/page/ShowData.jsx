...
export const ShowData = () => {
  ...
  let api = "https://masai-car-data.herokuapp.com/cars";
...
//   getdata()
  ...
  return (
    <div>
      showdata
      {box ? <Box /> : null}
      <button onClick={sorta}>high to low</button>
      {/* //map section */}
      {car?.map((e, index) => (
        <div className={styles.box} key={index}>
          ...
          <button onClick={() => pubg()}>open box</button>
